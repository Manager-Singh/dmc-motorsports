											...
											<div class="tab-content" id="myTabContent">
												...
												<div class="tab-pane fade show active" id="care-instructions" role="tabpanel">
													<div class="tab-single">
														<div class="row">
															<div class="col-12">
																<div class="single-des care-instructions">
																	<p>{!! ($product_detail->product->care_instructions) !!}</p>
												...
												<!--/ End care-instructions Tab -->
												<!-- Features Tab -->
												<div class="tab-pane fade show active" id="features" role="tabpanel">
													<div class="tab-single">
														<div class="row">
															<div class="col-12">
																<div class="single-des feature">
																	@foreach($product_detail->product->features as $feature)
																	<p>{!! ($feature->name) !!}</p>
																	@endforeach
